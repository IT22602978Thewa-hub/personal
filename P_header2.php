...
<head>
    ...
    <link rel="stylesheet" href="styles/P_styles.css">
...
<?php
    ...
    <header>
        ...
        <nav>
            <div class="pic">
                <img src="img/download.png" alt="logo" width="32px" height="32px">
    ...
    <div class="P_Content" id="P_idContent">
    
    <p>
        <br> <br> <br> <br> <br> <br>
        <div class="background_image"  style = "background-image: url(./img/P4.jpg); background-size: cover;">