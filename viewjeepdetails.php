...
<head>
   ...
   <title>View Jeep Details</title>
   <link rel="stylesheet" href="styles/raminduformviewjeep.css">
...
<body>
   ...
   <header>
        ...
        <nav>
            ...
            <ul class="menu">
                <li><a href="./r_main2.php" target="_blank">Home</a></li>
    ...
    <section>
      <div class="tableviewhead">
         <h1>Jeep Reservation List</h1>
         <div class="left">
            <form action="searchjeepdata.php" method="post">
      ...
      <table border="1">
         ...
         <tbody>
            <?php
               include 'dbh.inc.php';
               $sql = "SELECT * FROM jeepreservation";
